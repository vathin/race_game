...
while game:
    ...
    if inGame:
        ...
        if kpr[K_UP]:
            ...
            if car1.img !='sprites/up.png' and not car1.onTouch:
                car1.img_change('sprites/up.png', 30, 60)#26, 52
        if kpr[K_DOWN]:
            yal = 1
            car1.inMove = True
            if car1.img !='sprites/down.png' and not car1.onTouch:
                car1.img_change('sprites/down.png', 30, 60)
        if kpr[K_LEFT]:
            xal = -1
            car1.inMove = True
            if car1.img !='sprites/left.png' and not car1.onTouch:
                car1.img_change('sprites/left.png', 60, 30)
        if kpr[K_RIGHT]:
            xal = 1
            car1.inMove = True
            if car1.img !='sprites/right.png' and not car1.onTouch:
                car1.img_change('sprites/right.png', 60, 30)
    ...
    if goToLevel:
        ...
        car1 = GameSprite('sprites/right.png', carx, cary, 7, 60, 30)
