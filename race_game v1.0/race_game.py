...
quitButton = Button(400, 340, 250, 100, 'sprites/button1.png')
...
quitLab = ButLabel(quitButton.x, quitButton.y, quitButton.width, quitButton.height)
quitLab.set_text('Выход', 30)
...
menu_buttons_labs.append(quitLab)
...
while game:
    ...
    if carChangeMenu:
        if best_time['lv1t'] <= 100 and not car2_available:
            car2_available = True
            car2ChangeLab1.set_text('Доступно', 22)
            car2ChangeLab2.set_text('', 0)
        elif best_time['lv1t'] > 100 and car2_available:
            car2ChangeLab1.set_text(car2_text, 22)
            car2ChangeLab2.set_text(car2_text2, 22)
            car2_available = False
        elif best_time['lv2t'] <= 75 and not car3_available:
            car3_available = True
            car3ChangeLab1.set_text('Доступно', 22)
            car3ChangeLab2.set_text('', 0)
        elif best_time['lv2t'] > 75 and car3_available:
            car3ChangeLab1.set_text(car3_text, 22)
            car3ChangeLab2.set_text(car3_text2, 22)
            car3_available = False
        win.blit(menu_background, (0, 0))
